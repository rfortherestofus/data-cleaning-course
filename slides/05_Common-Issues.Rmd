...
Using remove empty and specifying rows, we get the same result as before, and because we set the quiet argument to FALSE, a small message tells us that five empty rows were removed out of tweleve in total.
