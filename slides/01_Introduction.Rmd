...
???
Hello and welcome to the Data Cleaning with R course.
Before we begin, let's define Data Cleaning. The following are quotes from some of the more common definitions.
---
...
Data cleaning involves fixing issues with our data to make them more usable. 
...
Let's try again. We can define data cleaning as a spectrum of data transformation steps to make data usable and to obtain more meaningful results from our workflows.
...
???
Then we determine which approach or tool we need to fix each issue
--
.large[
...
???
Most of the existing definitions of data cleaning mention fixing issues with the data, but these so colled issues are often mentioned without descriptions. I have tried to collect and describe the most common ones here.

Data in the real world usually have these issues. This list here is for reference, and we will deal with all of the most common issues in a later section of this course.
---
...
???
One of the main reasons I like R so much for data cleaning is because there are a number of tools and packages built specifically for this, which have good documentation and a large community of helpful users.
--
.large[
